...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://webService.my/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://webService.my/", "queryWeather");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.my/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.my/", name = "queryWeather")
